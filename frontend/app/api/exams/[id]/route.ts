/**
 * Serverless GET/PUT/DELETE /api/exams/[id].
 */
...
export async function GET(
  ...
  try {
    ...
    const doc = await examsCollection().doc(id).get();
    ...
    console.error('GET /api/exams/[id] error:', e);
...
export async function PUT(
  ...
  try {
    ...
    await examsCollection().doc(id).update(update);
    const updated = await examsCollection().doc(id).get();
